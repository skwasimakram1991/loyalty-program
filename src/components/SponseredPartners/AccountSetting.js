              ...
              <section className='partner-facilities-page main-page-size'>
                ...
                <div className='row'>
                  <div className='col-lg-5'>
                    ...
                    <p>
                      Fine-tune your account with our powerful settings.
                      Personalize your experience, adjust preferences, and
                      access features that enhance your productivity.
                    </p>
                  </div>
                ...
                <div className='row mr-t-24'>
                  <div className='col-lg-5'>
                    ...
                    <p>
                      ...
                      credentials now to keep your information safe and protect
                      your privacy. Change your password in just a few simple
                      steps and enjoy peace of mind knowing that your account is
                      well-protected.
                    </p>
                  </div>
                  <div className='col-lg-7'>
                ...
                <div className='row mr-t-24'>
                  <div className='col-lg-5'>
                    ...
                    <p>
                      ...
                      may have. simply fill out the contact form and one of our
                      support representatives will respond to you as soon as
                      possible. If you need immediate assistance, we recommend
                      using our live chat or phone support options.
                    </p>
                  </div>
                  <div className='col-lg-7'>
                    <div className='form-wrap'>
