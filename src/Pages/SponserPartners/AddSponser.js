      ...
      <div className='row'>
        <div className='col-lg-5 col-md-10'>
          ...
          <p>
            ...
            together to achieve common goals. Partnerships can take many forms,
            including joint ventures, collaborations, strategic alliances, and
            more.
          </p>
        </div>
            ...
            <form action=''>
              <div className='row'>
                <div className='col-lg-6 col-md-6'>
                  ...
                  <input type='text' placeholder='Enter sponsor’s name' />
                </div>
                <div className='col-lg-6 col-md-6'>
                  <label htmlFor=''>Sponsor name</label>
                  <input type='text' placeholder='Enter sponsor’s name' />
                ...
                <div className='col-lg-12'>
                  <ul>
                    <li>
                      <label>
                        <input type='radio' name='earn' id='' /> Business Light
                      </label>
                    ...
                    <li>
                      <label>
                        <input type='radio' name='earn' id='' /> Business Plus
                      </label>
                      <h5>Customer earn reward</h5>
                      <h6>
                    ...
                    <li>
                      <label>
                        <input type='radio' name='earn' id='' /> Business Pro
                      </label>
                      <h5>Customer earn reward</h5>
                      <h6>Users activity Dashboard (15 Days tiral)</h6>
                    </li>
