    ...
    <section className='manage-page main-page-size'>
      ...
      <div className='row'>
        <div className='col-lg-5'>
          <h3>Card details</h3>
          <p>
            provide your card details, The security of your information is of
            utmost importance to us, and we assure you that we have implemented
            strict measures to safeguard your data. Please enter your card
            details using the secure form provided.
          </p>
        </div>
