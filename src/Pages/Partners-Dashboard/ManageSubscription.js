      ...
      <div className='container-fluid'>
        ...
        <div className='row'>
          <div className='col-lg-5'>
            ...
            <p>
              Thank you for considering our subscription services! We offer a
              range of subscription options to fit your needs and budget. Please
              read below to learn more about our subscription plans.
            </p>
          </div>
        ...
        <div className='row mt-4'>
          <div className='col-lg-5'>
            ...
            <p>
              Here you can view all of your past invoices and payments. We keep
              a detailed record of all your billing activity, so you can easily
